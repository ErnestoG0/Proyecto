...
<body>
    ...
    <form class="form">
        ...
        <div class="form__radios">
            <div class="form__radio">
                <div class="tarjeta">
                    <div class="etiqueta">
                        ...
                        </svg>Tarjeta Credito/Debito</label>
                    </div>
                ...
                <input id="tarjeta" name="payment-method" type="radio" />
            </div>
            <div class="form__radio">
                <label><svg class="icon">
            ...
            <div class="form__radio">
                ...
                <select name="envio" id="">
                    <option value="DHL">DHL Express 1-2 Dias  $150</option>
                    <option value="Estafeta">Estafeta Estandar 3-5 Dias $120</option>
                </select>
            </div>
        </div>
        </fieldset>
        ...
        <table>
            ...
            <tr>
                <td>Precio Total</td>
                <td align="right"><span>$350</span></td>
            </tr>
            </tbody>
            <tfoot>
            <tr>
